...
import type { ConstructTuple } from "./ConstructTuple.type";

type PushUnknown<T extends unknown[]> = Push<T, unknown>;

type NumberRange<
  S extends number,
  E extends number,
  R extends number = S,
  L extends unknown[] = ConstructTuple<S>
> = Length<L> extends E
  ? R | E
  : NumberRange<S, E, R | Length<PushUnknown<L>>, PushUnknown<L>>;
